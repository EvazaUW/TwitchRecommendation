...
public class DevelopmentTester implements ApplicationRunner {
    ...
    // Test 3: user registration - UserService test
    ...
    @Override
    public void run(ApplicationArguments args) throws UserAlreadyExistException {
//        userService.register("default", "123456", "John", "Smith");
    }



//    // Test 2: Spring Data JDBC tests
//    private static final Logger logger = LoggerFactory.getLogger(DevelopmentTester.class);
//
...
//    // Test 1: test for ETwitchApiClient
//    private static final Logger logger = LoggerFactory.getLogger(DevelopmentTester.class);
//    private final ETwitchService etwitchService;
//    public DevelopmentTester(ETwitchService etwitchService) {
//        this.etwitchService = etwitchService;
//    }
//    @Override
//    public void run(ApplicationArguments args) {
//
//        List<Game> games = etwitchService.getGames("fortnite");
//        List<Game> topGames = etwitchService.getTopGames();
//        List<Video> videos = etwitchService.getVideos("21779", 2);
//        List<Clip> clips = etwitchService.getClips("21779", 2);
//        List<Stream> streams = etwitchService.getStreams(List.of("18122", "21779", "33214"), 10);
//
...
//
//        // Compare Sout -- logger is a better way to print, and can even print onto cloud
